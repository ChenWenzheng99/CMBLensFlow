...
ALILENS = "/sharefs/alicpt/users/chenwz/reconstruction_2048_simons2/test/ALILENS" #the library directory of your dataset and the final output
...
lmax = 3*nside-1
dlmax = 4096
seeds = [_ for _ in range(0,501)]  #0到200共201个realization (即simulation)
