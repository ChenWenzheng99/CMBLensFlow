...
#SBATCH --output=/sharefs/alicpt/users/chenwz/reconstruction_2048_simons2/log/output-%j.log
#SBATCH --error=/sharefs/alicpt/users/chenwz/reconstruction_2048_simons2/log/error-%j.log
...
# mpiexec python -W ignore /sharefs/alicpt/users/chenwz/reconstruction_2048_simons2/sims.py -np 10

# mpiexec python -W ignore /sharefs/alicpt/users/chenwz/reconstruction/sims_ali.py -np 5

# mpiexec python /sharefs/alicpt/users/chenwz/reconstruction_2048_simons/plot.py

# mpiexec python /sharefs/alicpt/users/chenwz/reconstruction_2048_simons2/lensingrec_quick.py
