...
klm_recon1 = hp.read_alm('/sharefs/alicpt/users/chenwz/reconstruction_2048_simons/test/ALILENS/products/COM_Lensing_Inhf_6143_R1/MV/dat_klm.fits')
klm_recon2 = hp.read_alm(os.path.join(ALILENS, 'products/COM_Lensing_Inhf_6143_R1/MV/dat_klm.fits'))
klm_recon = hp.almxfl(klm_recon1,weight1) + hp.almxfl(klm_recon2,weight2)
"""
# reconstruction map
