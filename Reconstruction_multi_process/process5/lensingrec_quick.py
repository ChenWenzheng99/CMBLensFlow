...
for qe_key in ['p', ]:
    ...
    for idx in range(0, len(seeds)):
        ...
        hp.write_alm(f"/sharefs/alicpt/users/chenwz/reconstruction_multi_process/process5/rec_qlm/rec_alm_{idx+400}.fits", qlm_rec, overwrite=True)
        print(f"rec_alm_{idx+400}.fits saved")
"""