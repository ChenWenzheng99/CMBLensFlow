...
for qe_key in ['p', ]:
    ...
    for idx in range(90, len(seeds)):
        ...
        hp.write_alm(f"/sharefs/alicpt/users/chenwz/reconstruction_multi_process/process2/rec_qlm/rec_alm_{idx+100}.fits", qlm_rec, overwrite=True)
        print(f"rec_alm_{idx+100}.fits saved")
"""