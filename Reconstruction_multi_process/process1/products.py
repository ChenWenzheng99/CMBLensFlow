...
par = SourceFileLoader('parfile', "/sharefs/alicpt/users/chenwz/reconstruction_2048_simons/params.py").load_module()
...
def nlkk_n1(k, clpp, nhl_dd, n1_dd, qresp_dd, savePath):
    ...
    ll = np.arange(lmax + 1)
    tqu = hp.read_map('/sharefs/alicpt/users/chenwz/reconstruction_2048_simons2/test/ALILENS/sims/cmbs/map_TQU_2048_0200.fits', field=(0, 1, 2))
    cl = hp.anafast(tqu)
