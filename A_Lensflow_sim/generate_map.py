...
def making_maps_new(nside, nrms_f=None,fwhm_f=None,phi_map=None,pixwin=False,seed=None):
    ...
    cl = camb_clfile('/root/download/plancklens/plancklens/data/cls/FFP10_wdipole_lenspotentialCls.dat',lmax_unl)   #l,TT,EE,BB,TE,PP,TP,EP
...
def making_maps(nside, nrms_f=None,fwhm_f=None,phi_map=None,pixwin=False):
    print('setting parameters...')
    nside = nside
    ...
    if phi_map is not None:
        ...
        plm = hp.synalm(cl['pp'],lmax=dlmax,new=True,verbose=False)
...
def making_maps_old(nside, fwhm=None,phi_map=None):
    print('setting parameters...')
    nside = nside
...
def making_maps_camb(nside, r, seed, fwhm=None, ):
    ...
    return Tlen, Qlen, Ulen, pmap, unlensed_total, lensed_cl, clpp