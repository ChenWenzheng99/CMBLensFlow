...
output_filename = f"/sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/output_temp_rec_new_phi/TEMP_MAP_{file_indices}.fits"
...
def delensing_ones(nside,nlev,theta_ac,):
    ...
    phi_noise = Prec - Pmap_full

    phi_noisy_part = phi_noisy*mask2                                       #noisy phi
...
if __name__ == "__main__":
    ...
    savePath = f'/sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/self_check_temp_rec_new_phi/auto'
    savePath2 = f'/sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/self_check_temp_rec_new_phi/cross'
    savePath3 = f'/sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/self_check_temp_rec_new_phi/de'
