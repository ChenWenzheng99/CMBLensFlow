...
def check_and_plot(nside, idx):
    ...
    pmap_input = hp.read_map(f'/sharefs/alicpt/users/chenwz/reconstruction_2048_simons/test/ALILENS/sims/cmbs/map_P_2048_{idx+380:04d}.fits')
    ...
    view_map((dmap_input_cut - dmap_rec_cut) * mask, title=f' Difference lensing map {idx+380:04d}',  cmap='YlGnBu_r', min=-0.0024, max=0.0024)
