...
ALILENS = "/sharefs/alicpt/users/chenwz/reconstruction_multi_process/process1/ALILENS" #the library directory of your dataset and the final output
...
lmax = 3*nside-1
dlmax = 4096
seeds = [_ for _ in range(121)]  #0到200共201个realization (即simulation)
