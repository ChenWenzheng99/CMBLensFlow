...
This is the first group of the 500 simulation, includes idx: 0-120. (Simulation will be performed in 'Reconstruction_Simons' and 'Reconstruction_Simons2')



Internal Reconstruction (Recommended) (Assuming we have 500 sets of simulation, here we use 0-120.)
2. Env.(alilens) : 
(1) Configuration :
...
(2) Move the '/ALILENS/temp/qlms_dd/sim_p_0xxx.fits'(xxx=0 to xxx=100) to '/process_added/ALILENS/temp/qlms_dd', run './move.sh'
