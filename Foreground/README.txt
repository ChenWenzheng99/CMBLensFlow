...
Notice that the parameter is fitted from the power spectra of the template maps(27GHz,39GHz,225GHz,280GHz) from PySM3(which actually based on Planck and WMAP observation maps), and the mask corresponds to AliCPT 10% sky patch.
