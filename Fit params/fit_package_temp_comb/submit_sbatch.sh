...
#SBATCH --output=/sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_comb/log/output-%j.log
#SBATCH --error=/sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_comb/log/error-%j.log
...
# mpiexec -n 5 python post_cal.py 195

# mpirun -np 60 python /sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_comb/fit.main.py 
mpirun -np 60 python /sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_comb/fit.main_cut.py
# mpirun -np 60 python /sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_comb/fit_main_HL.py

# mpirun -np 60 python /sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_rec_new3/fit_contribution.py

# mpirun -np 60 python /sharefs/alicpt/users/chenwz/Testarea/FORECAST/FOREGROUND_FORECAST/fit_package_temp_rec_new3/fit_main_HL_TEST.py

# mpiexec -n 3 python temp_forecast.py 180
